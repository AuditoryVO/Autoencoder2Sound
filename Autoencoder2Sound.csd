...
vslider bounds(10, 22, 30, 113), channel("level"), text("Level"), range(0, 1, 0.3, 1, 0.001) 
hslider bounds(435, 416, 122, 29) channel("Send"), text("REV"), range(0, 2, 1.5, 1, 0.001) 

hslider bounds(56, 416, 278, 29) channel("FreqFact"), text("Frequency factor"), range(0, 1, 0.5, 1, 0.001) 


vslider bounds(10, 142, 30, 113) channel("LpFrec"), text("LPF"), range(20, 20000, 5000, 0.5, 1) 
...
;kans1 OSClisten giosc_p, "/p", "f", gkplay
...
a0  oscil kAmp/4, gkf0*gkfFact, -1, 0
a1  oscil kAmp/4, gkf1*gkfFact, -1, 0
a2  oscil kAmp/4, gkf2*gkfFact, -1, 0
a3	oscil kAmp/4, gkf3*gkfFact, -1, 0
a4	oscil kAmp/4, gkf4*gkfFact, -1, 0
a5	oscil kAmp/4, gkf5*gkfFact, -1, 0
a6	oscil kAmp/4, gkf6*gkfFact, -1, 0
a7	oscil kAmp/4, gkf7*gkfFact, -1, 0
a8	oscil kAmp/4, gkf8*gkfFact, -1, 0
a9  oscil kAmp/4, gkf9*gkfFact, -1, 0
